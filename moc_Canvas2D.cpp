...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Canvas2D_t, stringdata) + ofs \
...
const QMetaObject Canvas2D::staticMetaObject = {
    { &SupportCanvas2D::staticMetaObject, qt_meta_stringdata_Canvas2D.data,
      qt_meta_data_Canvas2D,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Canvas2D.stringdata))
