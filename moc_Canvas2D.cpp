...
QT_MOC_LITERAL(1, 9, 12), // "cancelRender"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11), // "filterImage"
QT_MOC_LITERAL(4, 35, 12) // "animateBrush"

    },
    "Canvas2D\0cancelRender\0\0filterImage\0"
    "animateBrush"
};
...
void Canvas2D::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Canvas2D *_t = static_cast<Canvas2D *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cancelRender(); break;
        case 1: _t->filterImage(); break;
        case 2: _t->animateBrush(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Canvas2D::staticMetaObject = {
    { &SupportCanvas2D::staticMetaObject, qt_meta_stringdata_Canvas2D.data,
      qt_meta_data_Canvas2D,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
