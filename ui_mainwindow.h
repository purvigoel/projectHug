...
public:
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        brushDock->setWindowTitle(QApplication::translate("MainWindow", "Br&ush", Q_NULLPTR));
        brushType->setTitle(QApplication::translate("MainWindow", "Brush Type", Q_NULLPTR));
        brushTypeConstant->setText(QApplication::translate("MainWindow", "Constant", Q_NULLPTR));
        brushTypeLinear->setText(QApplication::translate("MainWindow", "Linear", Q_NULLPTR));
        brushTypeQuadratic->setText(QApplication::translate("MainWindow", "&Quadratic", Q_NULLPTR));
        brushTypeSmudge->setText(QApplication::translate("MainWindow", "S&mudge", Q_NULLPTR));
        brushTypeSpecial1->setText(QApplication::translate("MainWindow", "Special &1", Q_NULLPTR));
        brushTypeSpecial2->setText(QApplication::translate("MainWindow", "Special 2", Q_NULLPTR));
        brushColor->setTitle(QApplication::translate("MainWindow", "Brush Color", Q_NULLPTR));
        brushColorLabelGreen->setText(QApplication::translate("MainWindow", "G", Q_NULLPTR));
        brushColorLabelBlue->setText(QApplication::translate("MainWindow", "B", Q_NULLPTR));
        brushColorLabelRed->setText(QApplication::translate("MainWindow", "R", Q_NULLPTR));
        brushColorLabelAlpha->setText(QApplication::translate("MainWindow", "A", Q_NULLPTR));
        brushRadiusTextbox->setText(QString());
        brushRadiusLabel->setText(QApplication::translate("MainWindow", "Radius", Q_NULLPTR));
        brushAlphaBlendingCheckbox->setText(QApplication::translate("MainWindow", "No alpha blending", Q_NULLPTR));
        ...
        filterDock->setWindowTitle(QApplication::translate("MainWindow", "F&ilter", Q_NULLPTR));
        filterType->setTitle(QApplication::translate("MainWindow", "Filter Type", Q_NULLPTR));
        filterTypeEdgeDetect->setText(QApplication::translate("MainWindow", "Edge Detect", Q_NULLPTR));
        edgeDetectSensitivityLabel->setText(QApplication::translate("MainWindow", "Sensitivity", Q_NULLPTR));
        filterTypeBlur->setText(QApplication::translate("MainWindow", "Blur", Q_NULLPTR));
        blurRadiusLabel->setText(QApplication::translate("MainWindow", "Radius", Q_NULLPTR));
        filterTypeScale->setText(QApplication::translate("MainWindow", "Scale", Q_NULLPTR));
        scaleLabelX->setText(QApplication::translate("MainWindow", "X", Q_NULLPTR));
        scaleLabelY->setText(QApplication::translate("MainWindow", "Y", Q_NULLPTR));
        filterTypeRotate->setText(QApplication::translate("MainWindow", "Rotate", Q_NULLPTR));
        rotateAngleLabel->setText(QApplication::translate("MainWindow", "Angle", Q_NULLPTR));
        filterTypeSpecial1->setText(QApplication::translate("MainWindow", "Special 1", Q_NULLPTR));
        filterTypeSpecial2->setText(QApplication::translate("MainWindow", "Special 2", Q_NULLPTR));
        filterTypeSpecial3->setText(QApplication::translate("MainWindow", "Special 3", Q_NULLPTR));
