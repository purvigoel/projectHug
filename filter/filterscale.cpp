...
// Hprime function in the x direction
BGRA FilterScale::hPrime(int k, float a, BGRA *data, int heightTillNow, int width){
    ...
    // heightTillNow marks where we are in the backmapping in terms of the row number
...
// Perform the actual scaling in the x direction...
...
// For the marquee, we are only scaling the selected part. So,
// We crop out all the other parts of the canvas and create
// a new canvas with only the selected area. Then we can perform
